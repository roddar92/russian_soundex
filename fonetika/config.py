...
RU_PHONEMES = [
    (re.compile(r'(с?т|с|з)ч', re.I), r'щ'),  # Подписчик, заказчик.
    (re.compile(r'([тсзжцчшщ])([жцчшщ])', re.I), r'\2'),  # Визжать, обветшалый.
    (re.compile(r'(с)(т)([лнц])', re.I), r'\1\3'),  # Устлан, местный.
    ...
    (re.compile(r'([нc])(т)(г)', re.I), r'\1\3'),  # Рентген, бюстгальтер.
